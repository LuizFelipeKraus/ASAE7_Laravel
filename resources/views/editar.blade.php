...
@section('conteudo')
    ...
    <form action="{{route('usuario_alterar',['id'=> $us->id])}}" method="POST"  class="mt-5 pt-1">
        @csrf
        <img width="100" src="data:image/png;base64,"
            ...
            <h1 class="text-center">Editar Cadastro de Usuário</h1>
        <div class="input-group mb-3 pt-3">
            <span class="input-group-text" id="inputGroup-sizing-default">Nome</span>
            <input type="text" name="nome" placeholder="Nome" class="form-control" aria-label="Sizing example input"
                aria-describedby="inputGroup-sizing-default" value="{{$us->nome}}" id="f_nome">
        </div>
        <div class="input-group mb-2">
            ...
            <input type="text" name="endereco" max="120" min="0" placeholder="Endereco" class="form-control"
                aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="{{$us->endereco}} " id="f_endereco">
        </div>
        <div class="input-group mb-2">
            ...
            <input type="number" name="cep" placeholder="Cep" class="form-control"
                aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="{{$us->cep}}" id="f_cep">
        </div>
        <div class="input-group mb-2">
            ...
            <input type="text" name="cidade" placeholder="Cidade" class="form-control"
                aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" value="{{$us->cidade}}" id="f_cidade">
        </div>
        <div class="input-group mb-2">
        <span class="input-group-text" id="inputGroup-sizing-default">Estado</span>
            <select name="estado" class="form-select" id="inputGroupSelect01" value="{{$us->estado}}" id="f_estado">
